...
public:
    CustomTabLookAndFeel()
		{
			//setColour(TabbedButtonBar::ColourIds::frontTextColourId, Colours::yellow); // Couleur du texte du tab s�lectionn�
    ...
    void drawTabButton (TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown) override
		{
			...
			// Ajoutez ici un code personnalis� pour dessiner les onglets si n�cessaire
		}
};
...
public:
  ...
  //--- list of objects
    ...
    juce::TextEditor *Manager_essai3;
    juce::Label *Manager_essai3_text;
    juce::Label *Manager_essai3_texte;
  ...
  //--- list of unvisible objects (just for compilation)
    ...
    void Met_a_jour_Manager_essai3();  //  c++ value --> widget value
    void Process_message_Manager_essai3();  //  widget value --> c++ value
...
//........
	...
	void Save_parameters(string name_params, Processor * processor, MemoryBlock& destData);
	void Load_parameters(string name_params, Processor * processor, const void* data, int sizeInBytes);
